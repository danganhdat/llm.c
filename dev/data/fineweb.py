...
if __name__ == '__main__':
    ...
    parser.add_argument("-t", "--type", type=str, default="classic", help="Fineweb type, edu|classic|wiki|bkai")
    parser.add_argument("-v", "--version", type=str, default="10B", help="Fineweb data sample size, 10B|100B|1.1GB|17M")
    parser.add_argument("-m", "--model_desc", type=str, default="gpt-2", help="Model descriptor, gpt-2|llama-3|vi")
    ...
    assert args.version in {"10B", "100B", "1.1GB", "17M"}, "version must be one of: 10B, 100B, 1.1GB, 17M"
    assert args.type in {"edu", "classic", "wiki", "bkai"}, "type must be one of: edu, classic, wiki, bkai"
    directories = {
